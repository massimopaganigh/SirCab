...
%wingetcreate_path% update --submit --token "%sybau%" --urls "https://github.com/massimopaganigh/SirCab/releases/download/%version_raw%/SirCab.CLI_fat.zip" --version %version_raw% SirCab.SirCab
